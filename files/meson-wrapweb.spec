...
%license COPYING
%doc README.md
%config(noreplace) %{_sysconfdir}/wrapdb.cfg
%config(noreplace) %{_sysconfdir}/nginx/conf.d/wrapdb.conf
%attr(-,uwsgi,uwsgi)%{_localstatedir}/www/wrapweb/
%config(noreplace) %attr(-,uwsgi,uwsgi)%{_sysconfdir}/uwsgi.d/wrapdb.ini
